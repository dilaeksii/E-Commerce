export const ProductCard = ({product}) => {
    ...
    return (<div>
        ...
        <div className="flex flex-col items-center">
            ...
            <p><span className="text-[#BDBDBD] font-bold text-base leading-[24px]">{product.price}</span>{" "}<span className="text-[#23856D] font-bold text-base leading-[24px]">{product.salePrice}</span></p>
        </div>
    </div>);
}