...
export const SaleBlog = ({ card }) => {
  ...
  const isLiked = likedItems[card.id] || false;
  ...
  return (
    <div className="w-[501px] h-[404px] max-sm:w-[330px] max-sm:h-[606px] max-sm:mx-4">
      <div className="grid grid-cols-2 max-sm:grid-cols-1">
        {!blog && (
          ...
          >
            ...
            <div className="flex justify-around place-items-end pb-2 max-sm:hidden">
              <button
                className="bg-[#FFFFFF] rounded-full w-[40px] h-[40px] text-[#252B42] flex items-center justify-center"
                onClick={() => dispatch(toggleLike(card.id))}
              >
                <Heart
        ...
        {blog && (
          <div className="hidden flex flex-col max-sm:flex">
            <div
